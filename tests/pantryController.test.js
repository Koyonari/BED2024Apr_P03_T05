...
describe('Pantry Controller', () => {
    ...
    describe('getPantryIngredients', () => {
      it('should return pantry ingredients for a user', async () => {
        ...
        req.userid = '123';
        Pantry.getIngredients.mockResolvedValue([{ name: 'Tomato', quantity: 10 }]);
      ...
      it('should return 401 if user ID is not available', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: 'Unauthorized: User information not available' });
      });
    });
    ...
    describe('getPantryIDByUserID', () => {
      ...
      it('should return 404 if no pantry is found for the user', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: 'No pantry found for the user' });
      });
    });
    ...
    describe('addIngredientToPantry', () => {
      it('should add an ingredient to a pantry', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(201);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient added to pantry', result: { success: true } });
      });
    });
    ...
    describe('getIngredientsByPantryID', () => {
      it('should return all ingredients in a pantry', async () => {
        const { req, res } = createMocks();
        req.params = { pantry_id: '1' };
        Pantry.getIngredientsByPantryID.mockResolvedValue([{ name: 'Tomato', quantity: 10 }]);
      ...
      it('should return 404 if no ingredients are found', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(404);
        expect(res.json).toHaveBeenCalledWith({ message: 'No ingredients found in pantry' });
      });
    });
    ...
    describe('addIngredientQuantity', () => {
      it('should update ingredient quantity in pantry', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient quantity updated in pantry', result: { success: true } });
      });
    });
    ...
    describe('deductIngredientQuantity', () => {
      it('should deduct ingredient quantity and remove if zero', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient removed from pantry' });
      });
      ...
      it('should deduct ingredient quantity without removal if not zero', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient quantity updated in pantry', result: { quantity: 5 } });
      });
    });
    ...
    describe('updateIngredientInPantry', () => {
      it('should update an ingredient in a pantry', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient updated in pantry', result: { success: true } });
      });
    });
    ...
    describe('deleteIngredientFromPantry', () => {
      it('should delete an ingredient from a pantry', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: 'Ingredient removed from pantry', result: { success: true } });
      });
    });
  });